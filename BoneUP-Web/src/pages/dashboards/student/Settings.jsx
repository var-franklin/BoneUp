							...
							<div className="p-6 space-y-6">
								...
								<div>
									...
									<div className="space-y-4">
										<div className="flex items-center justify-between py-3 border-b border-gray-100">
											<div>
												<p className="text-sm font-medium text-gray-900">New Lessons</p>
												<p className="text-xs text-gray-600 mt-0.5">Get notified when new lessons are available</p>
											</div>
										...
										<div className="flex items-center justify-between py-3 border-b border-gray-100">
											<div>
												...
												<p className="text-xs text-gray-600 mt-0.5">Receive emails when you earn achievements</p>
											</div>
											<label className="relative inline-flex items-center cursor-pointer">
												<input
													type="checkbox"
										...
										<div className="flex items-center justify-between py-3">
											<div>
												<p className="text-sm font-medium text-gray-900">Learning Reminders</p>
												<p className="text-xs text-gray-600 mt-0.5">Daily reminders to continue learning</p>
											</div>
											<label className="relative inline-flex items-center cursor-pointer">
												<input
													type="checkbox"
								...
								<div className="pt-6 border-t border-gray-200">
									...
									<div className="space-y-4">
										<div className="flex items-center justify-between py-3 border-b border-gray-100">
											<div>
												<p className="text-sm font-medium text-gray-900">Simulation Updates</p>
												<p className="text-xs text-gray-600 mt-0.5">New simulations and challenges</p>
											</div>
											<label className="relative inline-flex items-center cursor-pointer">
												<input
													type="checkbox"
										...
										<div className="flex items-center justify-between py-3">
											<div>
												<p className="text-sm font-medium text-gray-900">Streak Alerts</p>
												<p className="text-xs text-gray-600 mt-0.5">Reminders to maintain your learning streak</p>
											</div>
											<label className="relative inline-flex items-center cursor-pointer">
												<input
													type="checkbox"
						...
						<div className="bg-white rounded-lg border border-gray-200 shadow-sm">
							...
							<div className="p-6 space-y-6">
								...
								<div className="flex items-center justify-between py-4 border-t border-gray-200">
									<div>
										<p className="text-sm font-medium text-gray-900">Autoplay Videos</p>
										<p className="text-xs text-gray-600 mt-0.5">Automatically play next lesson video</p>
									</div>
									<label className="relative inline-flex items-center cursor-pointer">
										<input
											type="checkbox"
								...
								<div className="flex items-center justify-between py-4 border-t border-gray-200">
									<div>
										<p className="text-sm font-medium text-gray-900">Show Subtitles</p>
										<p className="text-xs text-gray-600 mt-0.5">Display subtitles in video lessons</p>
									</div>
									<label className="relative inline-flex items-center cursor-pointer">
										<input
											type="checkbox"
							...
							<div className="p-6 space-y-6">
								...
								<div className="pt-6 border-t border-gray-200">
									...
									<div className="space-y-3">
										<button className="w-full px-4 py-2.5 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors text-left flex items-center gap-2">
