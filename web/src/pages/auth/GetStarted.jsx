//file path: web/src/pages/auth/GetStarted.jsx

import { useState, useContext } from "react";
import { useNavigate, Link } from "react-router-dom";
import { AppContext } from "../../context/AppContext";
import { Eye, EyeOff, Mail, Lock, User, Fish, Check, X, ArrowLeft } from "lucide-react";
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-green-100 overflow-hidden">
          ...
          <div className="text-center p-8 pb-4">
            <div className="flex justify-center mb-4">
              <div className="w-16 h-16 bg-gradient-to-br from-[#04510e] to-green-700 rounded-2xl flex items-center justify-center shadow-lg">
          ...
          <div className="max-h-[calc(100vh-280px)] overflow-y-auto px-8 pb-6">
          ...
          <div className="px-8 pb-6 pt-4 border-t border-slate-200 bg-white">
